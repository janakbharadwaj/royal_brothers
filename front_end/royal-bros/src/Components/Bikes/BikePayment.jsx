        ...
        <div className={styles.main__cont}>
               ...
               <h1>Summary</h1>
                <div className={styles.main__cont__info}>
                    ...
                    <div className={styles.main__cont__infoMore}>
                      ...
                      <hr/>
                      <div>
                        Vishalpur (Nehru Bridge Corner)<br/>
                        B 429, Sakar-7 Ashram Rd, Vishalpur, Nehru Bridge Corner,<br/>
                         Ahmedabad, Gujarat 380009
                      </div>
                      <hr/>
                      <div className={styles.week__day__price}>
                          <div>Weekday - {no_of_hours()} hrs * rupee{singleBike.hourly_rate}/hr</div>
                      ...
                      <div className={styles.excess__charges}>
                          <div>km limit(?)
                              <br/>Excess km charges (?)</div>
                          <div>360km <br></br>4km</div>
                      </div>
            ...
            <div style={{textAlign:"left"}}>
                ...
                <div className={styles.makepayment__button}>
                    <button onClikc={handlePayment}>Make payment</button>
                </div>
