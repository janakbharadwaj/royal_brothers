...
const BikeItem = ({_id,bike_image,bike_name,pickUpDate,pickUpTime,dropOffDate,dropOffTime,handleBooking,hourly_rate}) => {
                                  ...
                                  <div className={styles.bikeItem__booking}>
                                    <div>
                                      <p>
                                        ...
                                        &#x20b9; {(pickUpDate && dropOffDate)  && Number(TimeConversion(pickUpDate,dropOffDate))*24*hourly_rate}
                                        <br />
                                        ( km included)
                                      </p>
                                    </div>
